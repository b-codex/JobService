...
/**
 * It takes a jobPost object and returns a new object with only the jobTitle, _id, jobType,
 * companyName, location, and tag properties
 * @param jobPost - {
 * @returns The serialize_user function is returning an object with the following properties:
 */
const serialize_user = (jobPost) => {
  return {
    // role: user.role,
